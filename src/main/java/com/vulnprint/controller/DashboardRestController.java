...
public class DashboardRestController {
    ...
    @GetMapping("/pentests")
    @PreAuthorize("hasAuthority(T(com.vulnprint.security.AppSecurityGuard).VIEW_DASHBOARD) or hasAuthority(T(com.vulnprint.security.AppSecurityGuard).GENERATE_REPORT)")
